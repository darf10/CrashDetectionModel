...
from workers.detection import DetectionWorker
...
class AccidentDetectionPipeline:
    def __init__(self, video_source, gpu_id=0, buffer_size=30):
        ...
        self.detection_worker = DetectionWorker(self.frame_queue, self.detection_queue)
        self.tracking_worker = TrackingWorker(self.detection_queue, self.tracking_queue)
